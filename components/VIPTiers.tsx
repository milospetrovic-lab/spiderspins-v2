  ...
  return (
    ...
    >
      <div className="max-w-6xl mx-auto">
        ...
        <div className="tier-reveal mt-10 flex flex-col sm:flex-row items-center justify-center gap-3 sm:gap-4">
          <a
            href="/#play-crypto"
            className="hover-target inline-flex items-center gap-2 px-7 py-3 bg-venom text-silk uppercase tracking-[0.18em] text-xs font-display font-medium hover:bg-strike transition-colors shadow-strike-glow"
          >
            Enter the Web
